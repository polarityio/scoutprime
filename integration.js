...
const CIDR_ICON =
  '<i class="fa fa-fw fa-cogs integration-text-bold-color" ></i>';
const FQDN_ICON =
  '<i class="fa fa-fw fa-globe integration-text-bold-color" ></i>';
...
function _isValidCidr(entityObj) {
  if (
    entityObj.types.indexOf("custom.cidr") >= 0 &&
